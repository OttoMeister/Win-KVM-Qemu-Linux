...
#vm_cdrom_1="$HOME/Schreibtisch/Arbeit/TIA_Portal_STEP7_Prof_Safety_WinCC_V20.iso"
#vm_cdrom_2="$HOME/Schreibtisch/Arbeit/Totally_Integrated_Automation_Portal_V20_Upd3.iso"
#vm_cdrom_3="$HOME/Schreibtisch/Arbeit/S7-PLCSIM_V20.iso"
#vm_cdrom_4="$HOME/Schreibtisch/Arbeit/STARTDRIVE_ADVANCED_V20.iso"
vm_kiosk_mode=no # use yes or no
vm_usb_redirect=no # use yes or no
vm_smb_drive=~/Schreibtisch/Arbeit 
vm_monitor_port=45458
